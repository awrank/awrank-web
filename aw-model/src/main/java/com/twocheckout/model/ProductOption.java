...
public class ProductOption {
	...
	public TwocheckoutResponse update(String apiusername, String apipassword) throws Exception {
	...
	public TwocheckoutResponse delete(String apiusername, String apipassword) throws Exception {
		HashMap<String, String> args = new HashMap<String, String>();
		args.put("option_id", String.valueOf(option_id));
	...
	public ProductOption refresh(String apiusername, String apipassword) throws Exception {
		HashMap<String, String> args = new HashMap<String, String>();
		args.put("option_id", String.valueOf(option_id));
