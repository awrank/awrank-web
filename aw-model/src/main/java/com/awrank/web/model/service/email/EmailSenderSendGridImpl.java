...
public class EmailSenderSendGridImpl implements EmailSender {
	...
	public void send(String template, Map<String, Object> params) throws Exception {
		...
		//TODO: refactor this search - build mapping and go via it
		 ...
		 if(params.containsKey("testactivation_email")) testactivation_email = (String) params.get("testactivation_email");
		 if(params.containsKey("testactivation_password")) testactivation_password = (String) params.get("testactivation_password");
		 if(params.containsKey("xsmtp_header_var_name")) xsmtp_header_var_name = (String) params.get("xsmtp_header_var_name");
		 if(params.containsKey("xsmtp_header_var_value")) xsmtp_header_var_value = (String) params.get("xsmtp_header_var_value");
		...
		BodyPart part1 = new MimeBodyPart();
			...
			if(key == null) key = SMTPAuthenticator.getHashed256(testactivation_email+"."+testactivation_password+"."+localAddr +"."+remoteAddr);
