...
public class OrderCreateResultPojo {
	...
	public OrderCreateResultPojo(String paymentUrl, BigDecimal amount, String productNameLocalize, Long paymentId, String paymentSystemExternalId, boolean testMode) {
