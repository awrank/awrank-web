...
public abstract class TwocheckoutApi {
	...
	public static String get(String urlSuffix, HashMap<String, String> args, String apiusername, String apipassword) throws Exception {
	...
	public static String post(String urlSuffix, HashMap<String, String> args, String apiusername, String apipassword) throws Exception {
		ArrayList<NameValuePair> params = TwocheckoutUtil.convert(args);
		String url = Twocheckout.baseURL + urlSuffix;
		String mainObject = null;
		URI uri;
